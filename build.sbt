...
lazy val mainProj = (project in file("main"))
  ...
  .settings(
    ...
    mimaSettings,
    mimaBinaryIssueFilters ++= Vector(
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.customRow"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.jvmPlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.jvmPlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.jvmPlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.jsPlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.jsPlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.nativePlatform"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("sbt.ProjectMatrix.nativePlatform"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("sbt.ProjectMatrix#ProjectMatrixDef.scalajsPlugin"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("sbt.ProjectMatrix#ProjectMatrixDef.nativePlugin"),
